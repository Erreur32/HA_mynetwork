...
[![Add-on version](https://img.shields.io/badge/version-0.1.23-blue)](https://github.com/Erreur32/HA_mynetwork)
...
| | Version | Description |
|---|--------|-------------|
| **HA_mynetwork** (add-on) | `0.1.23` | This add-on version (bump with `scripts/update-version.sh`). |
