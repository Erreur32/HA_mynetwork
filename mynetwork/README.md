...
[![Add-on version](https://img.shields.io/badge/version-0.1.22-blue)](https://github.com/Erreur32/HA_mynetwork)
[![MynetworK upstream](https://img.shields.io/badge/MynetworK-v0.7.14-orange)](https://github.com/Erreur32/MynetworK)
...
| | Version | Description |
|---|--------|-------------|
| **HA_mynetwork** (add-on) | `0.1.22` | This add-on version (bump with `scripts/update-version.sh`). |
| **MynetworK** (main project) | `v0.7.14` | Embedded app version. Keep in sync when bumping — see root [README](../README.md#versions-two-different-version-numbers). |
