...
| **MynetworK** (main project) | `v0.7.45` | Version of the embedded app. **Source of truth:** [MynetworK](https://github.com/Erreur32/MynetworK). Must stay up to date when you bump the add-on — `update-version.sh` fetches the latest from upstream and updates READMEs. |
...
[release-shield]: https://img.shields.io/badge/version-v0.1.25-blue.svg
[release]: https://github.com/Erreur32/HA_mynetwork/releases/tag/v0.1.25
[license-shield]: https://img.shields.io/badge/license-MIT-blue.svg
[mynetwork-shield]: https://img.shields.io/badge/MynetworK%20v0.7.45-orange.svg
