...
| | Version | Description |
|---|--------|-------------|
| **HA_mynetwork** (add-on) | `0.1.22` | Version of this repo (Home Assistant add-on). Bump with `scripts/update-version.sh`. |
| **MynetworK** (main project) | `v0.7.14` | Version of the embedded app. **Source of truth:** [MynetworK](https://github.com/Erreur32/MynetworK). Must stay up to date when you bump the add-on — `update-version.sh` fetches the latest from upstream and updates READMEs. |
...
[release]: https://github.com/Erreur32/HA_mynetwork/releases/tag/v0.1.22
[license-shield]: https://img.shields.io/badge/license-MIT-blue.svg
[mynetwork-shield]: https://img.shields.io/badge/MynetworK%20v0.7.14-orange.svg
